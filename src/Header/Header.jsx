          ...
          <div className="flex items-center gap-3">
            <Link to="/" className="flex items-center gap-3">
              ...
              <div className="hidden sm:block">
                <span className="block text-sm font-semibold text-white">Nishant Badgujar</span>
                <span className="block text-xs text-slate-300">Java • Frontend • Full‑Stack</span>
              </div>
            </Link>
          </div>
          ...
          <div className="hidden lg:flex lg:items-center lg:space-x-6">
            <ul className="flex items-center gap-1">
              {navItems.map((item) => (
                <li key={item.to}>
                  ...
                  >
                    {({ isActive }) => (
                      <span className={isActive ? "text-amber-400" : "text-slate-200 hover:text-amber-300"}>{item.label}</span>
                    )}
                  </NavLink>
                </li>
              ))}
            ...
            <div className="flex items-center gap-3 ml-4">
              <Link
                ...
                className="hidden sm:inline-block px-4 py-2 rounded-md bg-amber-500 text-slate-900 text-sm font-medium shadow hover:opacity-95"
              ...
              >
                {/* LinkedIn icon */}
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden>
                  <path d="M4.98 3.5C4.98 4.88 3.87 6 2.5 6S0 4.88 0 3.5 1.12 1 2.5 1 4.98 2.12 4.98 3.5zM0 8h5v16H0V8zm7.5 0h4.78v2.2h.07c.67-1.27 2.29-2.6 4.72-2.6 5.05 0 6 3.33 6 7.66V24h-5v-7.8c0-1.86-.03-4.26-2.6-4.26-2.6 0-3 2.04-3 4.12V24h-5V8z" fill="currentColor" />
                </svg>
              </a>
            </div>
          </div>
